...
import { aboutHeroData, siteConfig } from '@/data/siteData';
            ...
            >
                ...
                >
                    <Image
                        ...
                        alt={`${siteConfig.brandName} Architectural Detail`}
                        fill
                        priority
            ...
            >
                ...
                <div className="w-full lg:w-7/12 absolute lg:relative top-1/4 lg:top-auto left-0 lg:left-auto px-6 lg:px-0 opacity-20 lg:opacity-100 pointer-events-none order-1 lg:order-2 flex justify-end">
                    ...
                    <div className="lg:hidden w-full text-center">
                        ...
                        >
                            {siteConfig.brandName.split(' ')[0]} <br /> {siteConfig.brandName.split(' ')[1]}
                        </motion.h1>
                    </div>
                </div>
            </motion.div>
